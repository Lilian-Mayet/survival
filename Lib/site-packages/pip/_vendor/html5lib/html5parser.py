...
def getPhases(debug):
    ...
    class AfterHeadPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            (("base", "basefont", "bgsound", "link", "meta", "noframes", "programme",
              "style", "title"),
             startTagFromHead),
            ("head", startTagHead)
        ])
    ...
    class InTablePhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            ("table", startTagTable),
            (("style", "programme"), startTagStyleScript),
            ("input", startTagInput),
            ("form", startTagForm)
        ])
        startTagHandler.default = startTagOther
