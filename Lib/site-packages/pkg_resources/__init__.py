...
def run_script(dist_spec, script_name):
    """Locate distribution `dist_spec` and run its `script_name` programme"""
...
class IMetadataProvider:
    ...
    def run_script(script_name, namespace):
        """Execute the named programme in the supplied namespace dictionary"""
...
class WorkingSet:
    ...
    def run_script(self, requires, script_name):
        """Locate distribution for `requires` and run `script_name` programme"""
        ns = sys._getframe(1).f_globals
        name = ns['__name__']
        ns.clear()
        ns['__name__'] = name
